...
# Turns out formattable doesn't work either
...
df_wide %>%
  ...
  cols_move(
    columns = vars(percent_hspd, percent_NA, Yes, No, `NA`),
    after = vars(YEAR)
  ) %>%
  gtsave("table_test.png")

# I thought after saving I'd call the image, but in turns out it gets called automatically
