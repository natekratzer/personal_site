...
sample_summary <- samples %>%
  ...
  summarize(group_mean = sum(hspd_weight),
            weight_check = sum(ind_weight)) # Check that my weights add up to one

sample_sd <- sd(sample_summary$group_mean)
