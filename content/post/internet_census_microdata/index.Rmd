...
# And we can call the bootstrap function
boot_results <- bootstrap_pums(df = df_in, num_samples = 100, group_vars = c(YEAR, poverty))
...
# And we can call the bootstrap function
boot_results <- bootstrap_pums(df = df_in, num_samples = 100, group_vars = c(YEAR, age))
...
# And we can call the bootstrap function
boot_results <- bootstrap_pums(df = df_in, num_samples = 100, group_vars = c(YEAR, metro))
